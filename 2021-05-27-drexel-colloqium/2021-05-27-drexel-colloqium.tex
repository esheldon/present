...
\frame
{
    ...
    \begin{itemize}
        \item We could include Einstein's cosmological constant fudge factor
            {\color{gold} $\Lambda$} (ironically meant to keep the universe static)
            \begin{equation} 
                G_{\mu, \nu} + \Lambda g_{\mu, \nu} = \frac{8 \pi G}{c^4} T_{\mu, \nu}
            \end{equation}
        ...
        \item Either we need a cosmological constant {\color{gold} $\Lambda$}
            or we need some bizarre field ``dark energy'' with negative pressure {\color{gold}
            $p_{\mathrm{DE}}(t) = w \rho_{\mathrm{DE}}(t)$} with {\color{gold}$w < 0$}.

        \item If this component is small compared to the matter density $\rho$
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item We don't currently have enough information to tell these apart.
