...
\title{Cosmology with Galaxy Surveys}
\author{Erin Sheldon}
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item The target audience is students with some background in physics
            but not necessarily astrophysics
        ...
        \item In the interest of pedagogy, I ask the experts to please refrain from commenting
            or asking questions :)
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Optical astronomy and Galaxy Surveys
        \item How we learn about cosmology with galaxy surveys
        \item Two examples
        ...
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item We call it a survey when the observations cover a large
                    contiguous part of the sky in, nearly uniformly.

                \item When the goal is mainly to study galaxies, we call it a
                    galaxy survey. We don't point at the milky way because it
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Recall from Paul's lecture: {\color{gold} $\Omega_m$} and {\color{gold} $\Omega_\Lambda$} were
            basic parameters in the Freedman Equations describing the expansion of the universe.
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item So far we have only published results from the first year of 5
                    
                \item DES will be the first lensing survey to make
                    informative measurements of Dark Energy
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item With galaxy surveys we can measure many of the
