...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Initially we were subtracting the model of the neighbor,
            ...
            some of the noise.  Noise model needed for \mcal\ and BFD.
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item New MOF shows separation-dependent biases.

        \item Scarlet deblender extremely flexible, clear improvement
            for large bright galaxies in dense fields.
            
        \item we don't know
            yet how to use it in the regime most useful for shear: 
            smallish faint galaxies
