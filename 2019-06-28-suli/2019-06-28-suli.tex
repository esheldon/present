...
\frame
{
    ...
    \begin{itemize}
        ...
        \item I'm also relying on some information the intro to cosmology by
            Paul Stankus. But if you were not there, that's ok, feel free to
            ask a question.

        \item My goal is to introduce basic concepts and give some examples

        \item I encourage questions. {\em I don't care if I get through 
            all of the material}

        \item In the interest of pedagogy, I ask those in the room with PhDs to
            please refrain from commenting or asking advanced questions :)
