...
\frame
{
    ...
    \begin{itemize}
        ...
        \item For \mcal\ and BFD we little increase in the noise
            \begin{itemize}

                \item \mcal for the smallest galaxies we would use $(T/T_{\textrm{PSF}} = 0.5)$ and typical $S/N = 15$
                    the increased noise of $\lesssim 1$\% (need to determine error on that)

                \item BFD, Bob reported a noise of 0.0007 for both
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item \mcal 
         ...
         \item BFD was run with less statistics
            \begin{align}
